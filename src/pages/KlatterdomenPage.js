...
const KlatterdomenPage = () => {
    ...
    return (
        <div className="text-white">
            ...
            <img src={data.projects[3].picture} alt='' className='rounded-sm border-y-2 py-5 border-neutral-800 object-cover w-full 2xl:h-[600px] md:h-[400px] h-[250px] transition-all duration-1000' />
                ...
                <div className="my-16 flex flex-col md:flex-row justify-between">
                    ...
                    <div className="flex flex-col mt-8 md:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <Link className="hover:text-neutral-400 transition-all duration-200" to={"https://zealous-sand-0a82c4103.4.azurestaticapps.net/"} target='_blank' rel='noopener noreferrer'>Preview</Link>
                        </div>
                    </div>
                </div>
            </div>
