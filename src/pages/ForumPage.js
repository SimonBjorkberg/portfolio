...
const ForumPage = () => {
    ...
    return (
        <div className="text-white">
            ...
            <img src={data.projects[1].picture} alt='' className='rounded-sm border-y-2 py-5 border-neutral-800 object-cover w-full 2xl:h-[600px] md:h-[400px] h-[250px] transition-all duration-1000' />
