    ...
    return (
        <div className="Info text-white font-sans">
            ...
            <div className='w-1/2 h-fit'>
                <h1 className='text-2xl mt-16 mb-4 text-neutral-400 font-light'>Documented competence</h1>
            ...
            <div className=''>
                <h1 className='font-light text-2xl mt-20 mb-4 text-neutral-400'>Experience</h1>
