    ...
    return (
        <div className="Info text-white font-sans">
            ...
            <div className='w-1/2 h-fit mt-16'>
                <h1 className='text-2xl mb-4 text-neutral-400 font-light'>Documented competence</h1>
            ...
            <div className='mt-20'>
                ...
                <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                    <div className='flex flex-col justify-between w-full'>
                        <h1 className='text-2xl mb-4'>Project 004 - Klätterdomen</h1>
                        <p className='mb-4 w-1/2 text-neutral-400'>A React web app created by me with the intention of getting better at TailwindCSS & SASS/SCSS while also experimenting with layouts.</p>
                    </div>
                    <div className='my-auto w-44 text-right'>
                        2023
                    </div>
                ...
                <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                    <div className='flex flex-col justify-between w-full'>
                        <h1 className='text-2xl mb-4'>Project 003 - E commerce</h1>
                        <p className='mb-4 w-1/2 text-neutral-400'>A React web app created by me and two classmates with the intention of learning React, Stripe, Socket.IO TailwindCSS & continue refining backend technologies.</p>
                    </div>
                    <div className='my-auto w-44 text-right'>
                        2023
                    </div>
                ...
                <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                    <div className='flex flex-col justify-between w-full'>
                        <h1 className='text-2xl mb-4'>Project 002 - Forum</h1>
                        <p className='mb-4 w-1/2 text-neutral-400'>A Handlebars web app created by me and a classmate with the intention of learning backend technologies such as creating our own database, schemas & routes.</p>
                    </div>
                    <div className='my-auto w-44 text-right'>
                        2023
                    </div>
                ...
                <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                    <div className='flex flex-col justify-between w-full'>
                        <h1 className='text-2xl mb-4'>Project 001 - Dino Game</h1>
                        <p className='mb-4 w-1/2 text-neutral-400'>A game created by me and a classmate with the intention of learning JavaScript classes and it's uses, as well as canvas.</p>
                    </div>
                    <div className='my-auto w-44 text-right'>
                        2023
                    </div>
                ...
                <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                    <div className='flex flex-col justify-between w-full'>
                        ...
                        <p className='mb-4 w-1/2 text-neutral-400'>A web application that me and two classmates built towards the end of high school, it was a reseller web application where we bought digital goods in bulk and sold them to specific buyers.</p>
                    </div>
                    <div className='my-auto w-44 text-right'>
                        2016 - 2018
                    </div>
            ...
            <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                <div className='flex flex-col justify-between w-full'>
                    ...
                    <p className='mb-4 w-1/2 text-neutral-400'>An intense 6 month fullstack JavaScript course with the prime goal of learning industry standard practices to be able to jump straight into the market.</p>
                </div>
                <div className='my-auto w-44 text-right'>
                    2023
                </div>
            ...
            <div className='font-light font-mono border-b mb-5 border-neutral-700 flex justify-between h-fit'>
                <div className='flex flex-col justify-between w-full'>
                    ...
                    <p className='mb-4 w-1/2 text-neutral-400'>An innovative high-school with a focus on innovation, coming up with new ideas & solving problems in creative ways. This is where my programming journey started.</p>
                </div>
                <div className='my-auto w-44 text-right'>
                    2014 - 2017
                </div>
