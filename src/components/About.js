...
const About = () => {
    return (
        <div className="text-white mx-auto w-full md:w-full relative">
            ...
            <p className="text-2xl font-mono max-w-[900px] my-16 md:leading-[50px] md:text-5xl md:[word-spacing:-10px] mx-2 md:mx-0">I'M A FRONT-END DEVELOPER BORN, RAISED & BASED IN GOTHENBURG.</p>
            <div className="flex mb-2 justify-between mx-2 md:mx-0">
