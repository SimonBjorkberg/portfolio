...
const Drawer = ({ project, setX }) => {
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="h-full md:mx-10+ mb-10 overflow-y-auto overscroll-none flex flex-col text-white">
                <p className="text-[4vw] md:text-[2vw] mb-2 h-fit mx-5 md:mx-0 w-fit">{project.title}</p>
                <p className='text-[12px] md:text-[16px] mb-2 mx-5 md:mx-0'>{project.description}</p>
                <div>
                ...
                <div className="w-full mt-10">
                    {project?.info?.map((info, i) => {
                        return <div key={i} className="w-full">
                            ...
                            <p className="mt-5 md:w-2/3 md:mx-0 mx-5 text-[12px] md:text-[16px]">{info.description}</p>
                        </div>
                    })}

                </div>
                <div className="mt-auto m-5 flex md:p-0 py-5">
